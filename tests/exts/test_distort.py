...
async def test_image(bot):
    ...
    message = await dpytest.message("https://t3.ftcdn.net/jpg/01/20/68/68/360_F_120686889_nDaqiMH8I5AmT5B0hpuJ14ZasdrrgRAK.jpg")
    assert await distort_helper(message) == f"{constants.Bot.file_cache}360_F_120686889_nDaqiMH8I5AmT5B0hpuJ14ZasdrrgRAK.jpg"
...
async def test_gif(bot):
    ...
    message = await dpytest.message("https://mir-s3-cdn-cf.behance.net/project_modules/hd/22550858835329.5a0b39c26d469.gif")
